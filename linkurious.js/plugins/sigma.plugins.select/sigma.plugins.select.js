;(function(undefined) {
  ...
  function Select(s, a, r) {
    ...
    this.clickNodesHandler = function(event) {
      ...
      this.clickStageHandler = function(event) {
	  a.dropNodes();
	  s.refresh({skipIndexation: true});
      };
    /**
    ...
    // Update active nodes and edges and update the node reference.
    function rectSelectHandler(event) {
      var nodes = event.data;
    ...
    /**
     * Bind the select plugin to handle rectSelect events.
     * @param  {sigma.plugins.rectSelect} rectSelect The rectSelect plugin instance.
     */
    this.bindRect = function(rectSelectInstance) {
      if (!rectSelectInstance) throw new Error('Missing argument: "rectSelectInstance"');

      rectSelect = rectSelectInstance;
      rectSelect.bind('selectedNodes', rectSelectHandler);
    };
    ...
    this.unbindRect = function() {
      if (rectSelect) {
        rectSelect.unbind('selectedNodes', rectSelectHandler);
      }
    }
