...
(function() {
	...
	this.open = function(o, options, x, y, onComplete) {
	    // Make sure current tooltip isn't closed by new hover if supposed to close by click
	    if (closeMethod == "clickStage" && options.show == "hovers")
		return;
	    remove();
	    closeMethod = options.hide;
